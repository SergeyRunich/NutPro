...
import { Table, Row, Col, Empty, Tag, Button, Popconfirm, notification, Checkbox } from 'antd'
              ...
              <center>
                ...
                {user.name !== 'david' && (
                  <div style={{ marginTop: '10px' }}>
                    ...
                    <Button
                      type="primary"
                      onClick={() => dublicateTemplate(template.id)}
                      style={{ margin: '0 0px 0px 5px' }}
                    >
                      {formatMessage({ id: 'TemplateDetail.Duplicate' })}
                    </Button>
                  </div>
                )}
                    ...
                    <table style={tableStyle}>
                      <tbody>
                        <tr>
                          ...
                          <th style={sharedStyle}>{formatMessage({ id: 'TemplateDetail.Min' })}</th>
                          <th style={sharedStyle}>{formatMessage({ id: 'TemplateDetail.Max' })}</th>
                        </tr>
                        {testData.map(item => (
                          <tr key={Math.random()}>
