...
class CreateTemplateForm extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <Drawer
          title={formatMessage({ id: 'CreateTemplateForm.CreateNewTemplate' })}
          width="100%"
          height="100%"
        ...
        >
          <Form layout="vertical" onSubmit={this.onSend}>
            <Row gutter={16}>
              <Col md={16} sm={24}>
                <Form.Item label={formatMessage({ id: 'CreateTemplateForm.Title' })}>
              ...
              <Col md={4} sm={24}>
                <Form.Item label={formatMessage({ id: 'CreateTemplateForm.RequiredPositions' })}>
            ...
            <Row gutter={16}>
              <Col md={24} sm={24}>
                <Divider orientation="left">
                  {formatMessage({ id: 'CreateTemplateForm.Positions' })}
